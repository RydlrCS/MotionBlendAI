...
def test_gsutil_cp_pipeline_yaml():
    ...
    """
    local_path = "/home/rydlr94/MotionBlendAI/MotionBlendAI-1/project/vertex_pipeline/pipeline.yaml"
    ...
    assert "Operation completed" in result.stdout, "Upload did not complete successfully."
